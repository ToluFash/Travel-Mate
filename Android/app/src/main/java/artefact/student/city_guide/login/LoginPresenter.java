package artefact.student.city_guide.login;
...
class LoginPresenter {
    ...
    public void ok_signUp(final String firstname, final String lastname, final String email,
        ...
        //Execute request
        Request request = new Request.Builder().addHeader("Authorization", "Basic YWRtaW46YWRtaW4=")
                .url(uri)
                .post(requestBody)
                .build();
                ...
                mhandler.post(() -> {
                    try {
                        ...
                        if (responseCode == HttpsURLConnection.HTTP_CREATED && res.equals(successfulMessage)) {
                            ...
                            // show error message
                            mView.showMessage("" + responseCode);
                            mView.showMessage("" + responseCode);
                        }
                        mView.dismissLoadingDialog();
                    } catch (Exception e) {
